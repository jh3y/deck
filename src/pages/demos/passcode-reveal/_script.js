...
revealer.addEventListener("click", () => {
  const pressed = !revealer.matches('[aria-pressed="true"]')
  revealer.setAttribute("aria-pressed", pressed)
  formGroup.dataset.visible = pressed
...
//             return (
//               <span
//                 className={`dummy__char ${index > 13 ? "dummy__char--static" : ""}`}
//                 key={`${char}--${index}`}
//               >
//                 {index <= 13 && char !== " " ? (
